...
class cleanto_dummy{
	...
	public function add_services_method_unit(){
		$query="insert into `".$this->service_methods_units."` (`id`,`services_id`,`methods_id`,`units_title`,`base_price`,`maxlimit`,`status`, `position`,`limit_title`,`unit_symbol`,`half_section`,`uduration`) values(NULL,'".$this->smu_service_id."','".$this->smu_methods_id."','".$this->smu_units_title."','".$this->smu_base_price."','".$this->smu_maxlimit."','".$this->smu_status."', '0','".$this->smu_limit_title."','".$this->smu_unit_symbol."','D','".$this->smu_uduration."')";
		$result=mysqli_query($this->conn,$query);
		$value=mysqli_insert_id($this->conn);
		return $value;
	}
	...
	public function add_order_client_info(){
		$query="insert into `".$this->order_client_info."` (`id`,`order_id`,`client_name`,`client_email`,`client_phone`,`client_personal_info`,`order_duration`) values(NULL,'".$this->oci_order_id."','".$this->oci_client_name."','".$this->oci_client_email."','".$this->oci_client_phone."','".$this->oci_client_personal_info."','".$this->oci_order_duration."')";
		$result=mysqli_query($this->conn,$query);
		$value=mysqli_insert_id($this->conn);
		return $value;
