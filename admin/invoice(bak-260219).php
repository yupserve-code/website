                    ...
                    if (mysqli_num_rows($res_order) > 0) {
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form id="invoice_form" name="invoice_form" method="post" action="save_invoice.php">
                                            ...
                                            <td class="price_dtls">
                                                <div class="form-group fl w100">
                                                    <div class="cta-col1-1 ct-w-50 mb-6" style="margin-right: 20px;">
                                                        ...
                                                        <input class="form-control addon_price valid decimal" name="addon_price[]" id="addon_price_<?php echo $row_addons->addons_service_id; ?>" type="text" autocomplete="off" required=""/>
                                                    </div>
                                                    <div class="cta-col1-1 ct-w-50 mb-6" style="margin-right: 20px;">
                                ...
                                ?>
                                <?php if (mysqli_num_rows($res_xtras) > 0) { ?>
                                    <?php $row_xtras = mysqli_fetch_object($res_xtras); ?>
                                    <table class="" style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group fl w100">
                                                        <div class="cta-col1-1 ct-w-50 mb-6" style="margin-right: 20px;">
                                                            <label for="city">Price</label>
                                                            <input class="form-control value_city valid decimal" name="extras_price" id="extra_addon_price_<?php echo $row_xtras->id; ?>" type="text" autocomplete="off" required=""/>
                                                        </div>
                                                        <div class="cta-col1-1 ct-w-50 mb-6" style="margin-right: 20px;">
                                                        ...
                                                        <div class="cta-col1-1 ct-w-50 mb-6" style="margin-right: 20px;">
                                                            ...
                                                            <input class="form-control value_state valid" name="extras_item_code" id="extras_item_code_<?php echo $row_xtras->id; ?>" type="text" autocomplete="off" required=""/>
                                                        </div>
                                                        <div class="cta-col1-1 ct-w-50 mb-6" style="margin-right: 20px;">
                                                            <label for="state">Tax Type</label>
                                                            <select class="form-control value_state valid" name="extras_tax_type" id="addon_tax_type_<?php echo $row_xtras->id; ?>" type="text" autocomplete="off" required="">
                                                                <option value="">Select tax type</option>
                                                                <option value="cgst">CGST</option>
                                                                <option value="sgst">SGST</option>
                                                                <option value="igst">IGST</option>
                                                        ...
                                                        <div class="cta-col1-1 ct-w-50 mb-6" style="margin-right: 20px;">
                                                            ...
                                                            <input class="form-control value_state valid number_only" name="extras_tax_prcnt" id="extra_addon_tax_prcent_<?php echo $row_xtras->id; ?>" type="text" autocomplete="off" required=""/>
                                                        </div>
                                                        <div class="cta-col1-1 ct-w-50 mb-6" style="margin-right: 20px;">
                                                            <label for="state">GST</label>
                                                            <input class="form-control value_state valid decimal" name="extras_gst" id="extra_addon_gst_<?php echo $row_xtras->id; ?>" type="text" autocomplete="off" required=""/>
                                                        </div>
                                                        <div class="cta-col1-1 ct-w-50 mb-6 "style="">
                                                            <label for="state">Total</label>
                                                            <input class="form-control value_state valid decimal" name="extras_total" id="extra_addon_total_<?php echo $row_xtras->id; ?>" type="text" autocomplete="off" required=""/>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
