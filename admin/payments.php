                            ...
                            while ($rs = mysqli_fetch_array($r)) {
                                ...
                                if ($rs['payment_method'] == "Stripe-payment" || strtolower(trim($rs['payment_method'])) == "card-payment" || $rs['payment_method'] == "Payway-payment") {
                                    ...
                                    if ($rs['payment_method'] == "Stripe-payment") {
                                        ...
                                        <td><?php if ($rs['transaction_id'] == "") {
                                        echo "-";
                                    } else {
                                        $p_t_id_res = str_split($rs['transaction_id'], 10);
                                        echo str_replace(",", " ", implode(",", $p_t_id_res));
                                    }
                                            ?>
                                        </td>
                                        <td><?php echo
                                    ...
                                    ?></td>
                                        <td><?php if ($rs['amount'] == 0) {
                                        echo $label_language_values['free'];
                                    } else {
                                        echo $general->ct_price_format($rs['amount'], $symbol_position, $decimal);
                                    } ?></td>
                                        <td>
                                            <?php
                                            if ($rs['frequently_discount'] == 'O') {
                                        ...
                                        <td><?php if ($rs['discount'] == 0) {
                                        echo "Free";
                                    } else {
                                        echo $general->ct_price_format($rs['discount'], $symbol_position, $decimal);
                                    } ?></td>
                                        <td><?php if ($rs['taxes'] == 0) {
                                        echo "Free";
                                    } else {
                                        echo $general->ct_price_format($rs['taxes'], $symbol_position, $decimal);
                                    } ?></td>
                                        <td><?php if ($rs['net_amount'] == 0) {
                                    echo "Free";
                                } else {
                                    echo $general->ct_price_format($rs['net_amount'], $symbol_position, $decimal);
                                } ?></td>
<!--                                        <td><?php if ($rs['partial_amount'] == 0) {
                                        echo "Free";
                                    } else {
                                        echo $general->ct_price_format($rs['partial_amount'], $symbol_position, $decimal);
                                    } ?></td>-->
                                        <?php } else { ?>
                                        <td>
                                            <?php
                                            if ($rs['payment_method'] == 'Pay At Venue') {
                                                echo 'Cash';
                                            } else {
                                                echo 'Online';
                                            }
...
<!--                                        <td><?php echo $rs['partial_amount'] == 0 ? "-" : $general->ct_price_format($rs['partial_amount'], $symbol_position, $decimal); ?></td>
        ...
        ?>
<!--                                        <td><a class="btn btn-primary send_inovoice" href="javascript:void(0);" id="send_inovoice" data-link="" data-email="" data-name="">
