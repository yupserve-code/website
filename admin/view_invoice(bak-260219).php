...
$pdf->Text(25, 35, $business_phone);
$pdf->Text(25, 40, $business_gst);
...
$pdf->Text(155 - $pdf->GetStringWidth($label_language_values['sub_total']), $addondetails_sttpoint + 15, $label_language_values['sub_total']);
if ($payinfo[11] == 'O') {
    $fd = "Once";
} elseif ($payinfo[11] == 'W') {
    $fd = "Weekly";
...
$pdf->Text(155 - $pdf->GetStringWidth($label_language_values['coupon_discount']), $addondetails_sttpoint + 20, $label_language_values['coupon_discount']);
$pdf->Text(155 - $pdf->GetStringWidth($label_language_values['tax']), $addondetails_sttpoint + 25, $label_language_values['tax']);
...
$pdf->SetFont('DejaVu', '', 10);
$pdf->Text(190 - $pdf->GetStringWidth($printamount), $addondetails_sttpoint + 15, $printamount);
//$pdf->Text(190 - $pdf->GetStringWidth($printfrequency), $addondetails_sttpoint + 20, $printfrequency);
$pdf->Text(190 - $pdf->GetStringWidth($printdiscount), $addondetails_sttpoint + 20, $printdiscount);
$pdf->Text(190 - $pdf->GetStringWidth($printtaxes), $addondetails_sttpoint + 25, $printtaxes);
...
$pdf->SetFont('DejaVu', '', 10);
$pdf->Text(23, 240, "Thank You!");
$pdf->SetFont('DejaVu', '', 10);
$pdf->Text(150, 240, "Authorized Signatory");
$pdf->SetFont('DejaVu', '', 10);
$pdf->Text(160, 250, $business_name);
