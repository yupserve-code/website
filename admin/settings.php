...
$manage_form_errors_message = array(
...
<div class="panel cta-panel-default" id="ct-settings">
    <div class="ct-settings ct-left-menu col-md-2 col-sm-2 col-xs-12 col-lg-2">
...
?>
    ...
    <div class="panel-body">
        <div class="ct-setting-details tab-content col-md-10 col-sm-10 col-lg-10 col-xs-12" style="overflow: scroll !important; padding: 0px !important;">
...
?>
  ...
  <input class='cta-toggle-checkbox' data-toggle="toggle" data-size="small" type='checkbox' name="" <?php  if($setting->get_option('ct_company_willwe_getin_status') == "Y") { echo "checked"; } ?>  id="show_how_willwe_getin_front" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
    ...
    echo 'checked';
                                                    ...
                                                    <div class="hide-div mycollapse_postalcode pt-15" <?php if ($setting->ct_postalcode_status == 'Y') {
                                                    ...
                                                    echo 'checked';
                                                            ...
                                                            <li class="ct-tax-vat-input-container">
                                                                <span class="ct-tax-vat-input-container">
                                                                    ...
                                                                    <span class="ct-partial-input-per"><input type="text" class="form-control" id="ct_partial_deposit_amount" name="cta-partial-deposit" value="<?php echo ($setting->ct_partial_deposit_amount) ?>" size="3" maxlength="3" /> <i class="ct-partial-deposit-percent <?php if ($setting->ct_partial_type == 'P') {
                                                    echo 'fa fa-percent';
                                                } ?>"></i></span>
                                                                </span><br/>
                                                            </li>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <i><?php echo $label_language_values['default_url_is']; ?> : <?php if ($setting->ct_thankyou_page_url == '') {
                                                    echo SITE_URL . 'front/thankyou.php';
                                                } else {
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <label class="ctoggle-cancel-policy" for="cancel-policy">
                                                    <input class="cta-toggle-checkbox" data-toggle="toggle" data-size="small" type='checkbox' name="ct_cancelation_policy_status" <?php if ($setting->ct_cancelation_policy_status == 'Y') {
                                                    echo 'checked';
                                                ...
                                                <div <?php
                                                if ($setting->ct_cancelation_policy_status == 'Y') {
                                                    echo 'style="display:block;"';
                                                }
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <label class="ctoggle-allow-dc-terms-condition" for="allow-dc-terms-condition">
                                                    <input class="cta-toggle-checkbox" data-toggle="toggle" data-size="small" type='checkbox' name="ct_allow_terms_and_conditions" <?php if ($setting->ct_allow_terms_and_conditions == 'Y') {
                                                    echo 'checked';
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <label class="ctoggle-allow-dc-privacy_policy" for="allow-dc-privacy_policy">
                                                    <input class="cta-toggle-checkbox" data-toggle="toggle" data-size="small" type='checkbox' name="allow-dc-privacy_policy" <?php if ($setting->ct_allow_privacy_policy == 'Y') {
                                                    echo 'checked';
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <select name="ct_method_default_design" id="ct_method_default_design" class="selectpicker" style="display: none;">
                                                    <option value="2" <?php if ($setting->ct_method_default_design == '2') {
                                                    echo 'selected';
                                                } ?>><?php echo $label_language_values['dropdown_design']; ?></option>
                                                    <option value="3" <?php if ($setting->ct_method_default_design == '3') {
                                                    echo 'selected';
                                                } ?>><?php echo $label_language_values['blocks_as_button_design']; ?></option>
                                                    <option value="4" <?php if ($setting->ct_method_default_design == '4') {
                                                    echo 'selected';
...
?>
    ...
    echo 'checked';
} ?>  value="default"><?php echo $label_language_values['Default_Loader']; ?></label>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
                                                        ...
                                                        <h4 class="panel-title">
                                                            ...
                                                            <div class="ct-enable-disable-right pull-right">
                                                                <label class="ctoggle-paypal-checkout" for="paypal-checkout">
                                                                    <input class='cta-toggle-checkbox payment_choice' data-toggle="toggle" data-size="small" type='checkbox' name="" <?php if ($setting->ct_paypal_express_checkout_status == 'on') {
    echo 'checked';
                                                        ...
                                                        <h4 class="panel-title">
                                                            ...
                                                            <div class="ct-enable-disable-right pull-right">
                                                                <label class="ctoggle-authorizedotnet-payment-checkout" for="authorizedotnet-payment-checkout">
                                                                    <input class='cta-toggle-checkbox payment_choice' data-toggle="toggle" data-size="small" type='checkbox' <?php if ($setting->ct_authorizenet_status == 'on') {
    echo 'checked';
                                                        ...
                                                        <h4 class="panel-title">
                                                            ...
                                                            <div class="ct-enable-disable-right pull-right">
                                                                <label class="ctoggle-twocheckout-payment-checkout" for="twocheckout-payment-checkout">
                                                                    <input class="cta-toggle-checkbox payment_choice" data-toggle="toggle" data-size="small" type='checkbox' <?php if ($setting->ct_2checkout_status == 'Y') {
    echo 'checked';
                                                        ...
                                                        <h4 class="panel-title">
                                                            ...
                                                            <div class="ct-enable-disable-right pull-right">
                                                                <label class="ctoggle-payumoney-payment-checkout" for="payu-money">
                                                                    <input class="cta-toggle-checkbox payment_choice" data-toggle="toggle" data-size="small" type='checkbox' <?php if ($setting->ct_payumoney_status == 'Y') {
                                        echo 'checked';
                                    } ?> name="" id="payu-money" data-on="<?php echo $label_language_values['enable']; ?>" data-off="<?php echo $label_language_values['disable']; ?>" data-onstyle='success' data-offstyle='danger' />
                                                                </label>
                                                            </div>
                                                        </h4>
                                                    </div>
                                                    <div id="collapseOne" <?php if ($setting->ct_payumoney_status == 'Y') {
                                        echo 'style="display:block"';
                                                        ...
                                                        <h4 class="panel-title">
                                                            ...
                                                            <div class="ct-enable-disable-right pull-right">
                                                                <label class="ctoggle-bank-transfer-payment-checkout" for="bank-transfer-payment-checkout">
                                                                    <input class="cta-toggle-checkbox" data-toggle="toggle" data-size="small" type='checkbox' <?php if ($setting->ct_bank_transfer_status == 'Y') {
                                        echo 'checked';
                                                    ...
                                                    <div class="ct-email-temp-collapse-div col-md-12 col-lg-12 col-xs-12 np">
                                                        <form id="" method="post" type="" class="slide-toggle email_template_form" >
                                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                                <textarea class="form-control" name="email_message<?php echo $ti; ?>" id="email_message_<?php echo $readall_client['id']; ?>" cols="50" rows="20" placeholder="Add here your message"><?php if ($readall_client['email_message'] != '') {
...
<!--                    <ul class="nav nav-tabs">
                    ...
                    <div class="tab-content">
                        <div class="" id="default-coupon">
                            <?php 
                                $sql_dflt_cpn = "SELECT * FROM ct_default_coupon";
                                $res_dflt_cpn = mysqli_query($conn, $sql_dflt_cpn);
                                $row_dflt_cpn = mysqli_fetch_object($res_dflt_cpn);
                            ?>
                            <h3>Default Promocode</h3>
                            <form id="default_coupon_form" method="post" type="" class="">
                                <div class="table-responsive">
                                    <table class="form-inline ct-common-table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="hidden" name="coupon_id" id="coupon_id" value="<?php echo $row_dflt_cpn->id; ?>"/>
                                                        <input type="text" class="form-control" id="coupon_code" name="coupon_code" value="<?php echo $row_dflt_cpn->coupon_code; ?>" placeholder="<?php echo $label_language_values['coupon_code']; ?>" /><br />
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <select name="coupon_type" id="coupon_type" class="selectpicker" data-size="3" style="display: none;">
                                                            <option value="Percentage" <?php echo ($row_dflt_cpn->coupon_type == 'Percentage') ? 'selected' : ''; ?>><?php echo $label_language_values['percentage']; ?></option>
                                                        </select>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="coupon_value" name="coupon_value" value="<?php echo $row_dflt_cpn->value; ?>" placeholder="<?php echo $label_language_values['value']; ?>" /><br />
                                                    </div>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td>
                                                    <a data-id="<?php echo $row_dflt_cpn->id; ?>" id="dflt_coupon" name="dflt_form_data" class="btn btn-success btn_" type="submit"><?php echo $label_language_values['update']; ?></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
