...
class Date_Slots {
    ...
    public function index() {
        ...
        if (!empty($_SERVER['REQUEST_METHOD']) && ($_SERVER['REQUEST_METHOD'] == "POST")) {
            ...
            if (!empty($_POST['customer_id']) && !empty($_POST['date'])) {
                ...
                $select_time = date('Y-m-d', strtotime($date_selected));
