			...
			<div class="ct-main-left ct-sm-12 ct-md-12 ct-xs-12 mt-10 br-5 np">
                 <div class="panel-group" id="accordion">
										...
										<form id="user_details_form" class="" method="post">
											<div class="ct-new-user-details remove_preferred_password_and_preferred_email">
												<div class="ct-md-6 ct-sm-6 ct-xs-12 ct-form-row">
													...
													<input type="text" name="ct_email" id="ct-email" class="add_show_error_class error" onblur="checkemailAvailability(this.value)" />
											...
											<div class="ct-peronal-details">
												...
												<div class="ct-md-6 ct-sm-6 ct-xs-12 ct-form-row">
													...
													<input type="tel" value="" id="ct-user-phone" class="add_show_error_class error" name="ct_user_phone" onblur="checkphoneAvailability(this.value)" />
												...
												<div class="ct-md-6 ct-sm-6 ct-xs-12 ct-form-row remove_city_class">
													...
													<input type="text" name="ct_city" id="ct-city" class="add_show_error_class error" value="Bhubaneswar" readonly="readonly" />
												</div>
												<?php   } else {
													?>
												...
												<div class="ct-md-6 ct-sm-6 ct-xs-12 ct-form-row remove_state_class">
													...
													<input type="text" name="ct_state" id="ct-state" class="add_show_error_class error" value="Odisha" readonly="readonly" />
												</div>
												<?php   } else {
													?>
					...
					<div class="ct-main-right ct-sm-8 ct-md-6 ct-xs-12 mt-30 mb-30 br-5 hide_allsss">
						<div class="fl">
							<div class="main-inner-container border-c ct-price-scroll" id="ct-price-scroll" style="display: none">
